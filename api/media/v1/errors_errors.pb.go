...
func IsInvalidContentType(err error) bool {
	if err == nil {
		return false
	}
	e := errors.FromError(err)
	return e.Reason == ErrorReason_INVALID_CONTENT_TYPE.String() && e.Code == 400
}

func ErrorInvalidContentType(format string, args ...interface{}) *errors.Error {
...
func IsS3uploadFailed(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ErrorReason_S3UPLOAD_FAILED.String() && e.Code == 500
}
