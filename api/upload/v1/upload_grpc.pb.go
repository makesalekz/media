...
func (c *uploadClient) UploadMedia(ctx context.Context, in *UploadMediaRequest, opts ...grpc.CallOption) (*UploadMediaReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.upload.v1.Upload/UploadMedia", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *uploadClient) UploadAvatar(ctx context.Context, in *UploadMediaRequest, opts ...grpc.CallOption) (*UploadMediaReply, error) {
	out := new(UploadMediaReply)
	err := c.cc.Invoke(ctx, "/api.upload.v1.Upload/UploadAvatar", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Upload_UploadMedia_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.upload.v1.Upload/UploadMedia",
	}
...
func _Upload_UploadAvatar_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.upload.v1.Upload/UploadAvatar",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
