...
func (mq *MediaQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (mq *MediaQuery) FirstIDX(ctx context.Context) int64 {
...
func (mq *MediaQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (mq *MediaQuery) OnlyIDX(ctx context.Context) int64 {
...
func (mq *MediaQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (mq *MediaQuery) IDsX(ctx context.Context) []int64 {
	ids, err := mq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (mq *MediaQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(media.Table, media.Columns, sqlgraph.NewFieldSpec(media.FieldID, field.TypeInt64))
	_spec.From = mq.sql
