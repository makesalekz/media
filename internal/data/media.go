...
type MediaRepo interface {
	...
	SetDims(ctx context.Context, media *ent.Media, dto SetDimslDto) (*ent.Media, error)
...
func (r *mediaRepo) SetDims(ctx context.Context, media *ent.Media, dto SetDimslDto) (*ent.Media, error) {
	return media.Update().
